...
let s:mediumer_gray   = { "gui": "#999999", "cterm": "243" }
let s:white           = { "gui": "#F1F1F1", "cterm": "15"  }
let s:lighter_white   = { "gui": "#F8F8F8", "cterm": "15"  }
...
let s:lightest_black  = { "gui": "#5A5A5A", "cterm": "239" }
let s:light_gray      = { "gui": "#A8A8A8", "cterm": "248" }
let s:lightr_gray     = { "gui": "#B7B7B7", "cterm": "251" }
let s:lighter_gray    = { "gui": "#C6C6C6", "cterm": "251" }
let s:lightest_gray   = { "gui": "#EEEEEE", "cterm": "255" }
let s:dark_red        = { "gui": "#CA274D", "cterm": "1"   }
let s:medium_red      = { "gui": "#E96167", "cterm": "1"   }
...
if &background == "dark"
    ...
    let s:bg              = s:lighter_white
    let s:bg_subtle       = s:lightr_gray
    let s:bg_very_subtle  = s:lightest_gray
    let s:norm            = s:lightest_black
    let s:norm_subtle     = s:mediumer_gray
    let s:red             = s:medium_red
    let s:cyan            = s:dark_cyan
    let s:green           = s:dark_green
    let s:visual          = s:light_red
    let s:yellow          = s:light_yellow
